...
//
//     final lastFiveTaskModel = lastFiveTaskModelFromJson(jsonString);

import 'dart:convert';

LastFiveTaskModel lastFiveTaskModelFromJson(String str) => LastFiveTaskModel.fromJson(json.decode(str));

String lastFiveTaskModelToJson(LastFiveTaskModel data) => json.encode(data.toJson());

class LastFiveTaskModel {
  LastFiveTaskModel({
    this.status,
    this.message,
    this.data,
  ...
  factory LastFiveTaskModel.fromJson(Map<String, dynamic> json) => LastFiveTaskModel(
    status: json["status"],
