...
//
//     final dashboardDetailProfileModel = dashboardDetailProfileModelFromJson(jsonString);

import 'dart:convert';

DashboardDetailProfileModel dashboardDetailProfileModelFromJson(String str) => DashboardDetailProfileModel.fromJson(json.decode(str));

String dashboardDetailProfileModelToJson(DashboardDetailProfileModel data) => json.encode(data.toJson());

class DashboardDetailProfileModel {
  DashboardDetailProfileModel({
    this.status,
    this.message,
    this.data,
  });
  ...
  factory DashboardDetailProfileModel.fromJson(Map<String, dynamic> json) => DashboardDetailProfileModel(
    status: json["status"],
